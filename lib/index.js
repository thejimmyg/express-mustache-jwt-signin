...
const setupLogin = (app, secret, credentials, options) => {
  const { dashboardURL = '/dashboard', jwtCookieName = 'jwt', extractTokenFromRequest = extractTokenFromRequestDefault, signOutURL = '/signout', signInURL = '/signin', ...rest } = options || {}
